                ...
                <div className={"about-info-container"}>
                    ...
                    <div className={(panel === 2) ? "about-info" : "about-info about-info-hidden"}>
                        ...
                        <p className={"attention"}>
                            <FontAwesomeIcon icon={faReact}/> Можете попробовать игру 2048 <a href={"http://localhost:3000/playground/ttfe"}>здесь</a>
                        </p>
                    ...
                    <div className={(panel === 3) ? "about-info" : "about-info about-info-hidden"}>
                        ...
                        <ul>
                            <li><FontAwesomeIcon icon={faReact}/> Начало</li>
                            <li><FontAwesomeIcon icon={faReact}/> Старт</li>
                            <li><FontAwesomeIcon icon={faReact}/> основная часть</li>
                            <li><FontAwesomeIcon icon={faReact}/> Конец</li>
                        </ul>
                        <p className={"attention"}><FontAwesomeIcon icon={faReact}/> Сапёр имеет несколько вариантов реализации, я так же взял самый
                        ...
                        попасть в бомбу, очень редко может попастьв  цифру, чаще всего попадает в пустую ячейку и открывается часть поля</p>

                        <p className={"p-main"}>3. основная часть</p>
                        <p>игрок может ставить флажки и пытаться разминировать поле, игра заканчивается когда больше не останется ячеек без бомб или если игрок попадет на бомбу</p>

                        <p className={"p-main"}>4. конец</p>
                        <p>когда игрок закончил игру победой или поражением, рекорд записывается и можно начать заново.</p>

                        <p className={"attention"}><FontAwesomeIcon icon={faReact}/> В моей версии сапрера достаточно
                            простой алгоритм спавна мин, поэтому может случиться ситуация, когда невозможно просчитать,
                            где
                            находится мина и игроку придется угадывать. Можете попробовать поиграть в сапёра <a href={"http://localhost:3000/playground/minesweeper"}>здесь</a>
                        </p>
                    </div>
                </div>
            </section>
